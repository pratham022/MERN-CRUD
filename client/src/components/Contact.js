    ...
    return (
        <div className="container">
            ...
            <div className="row mt-5">
                ...
                <div className="col-md-3 mx-1">
                    <input type="number" class="form-control mt-2" placeholder="Your Phone Number" aria-label="Your Phone Number" id="phone" name="phone"></input>
                </div>
                <div className="col-md-12 mx-1">
                    <textarea type="text" class="form-control mt-2" placeholder="Message" aria-label="Message" id="message" name="message"></textarea>
                </div>
